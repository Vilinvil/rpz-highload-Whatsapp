...
|:--------------------------------------------------:|:----------------:|
| AMD EPYC 7413 24 Cores 2.65GHz/3.6GHz, 128MB Cache |     224 312      |

**Redis**:
Общий объем по кол-ву активных пользователей в месяц.
1 Кбайт * 482 000 000 = 460 Гбайт
Прирост из-за новых пользователей в месяц:
1 Кбайт * 9 регистраций в секунду * (60сек * 60мин * 24ч * 30д) = 23 Гбайт

### Конфигурация серверов

|                   Название                    |    Хостинг     | Конфигурация | Cores | Cnt | Покупка | Аренда |
|:---------------------------------------------:|:--------------:|:------------:|:------------:|:------------:|:------------:|:------------:|
|              web && mobile nginx              | own bare metal |              | ||||
|           web && mobile api gateway           | own bare metal |              |||||
|                   auth.auth                   |   own Kuber    |              |||||
...
|                     Redis                     | own bare metal |              |||||
|                   Cassandra                   | own bare metal |              |||||
|                   Amazon S3                   |     amazon     |              |||||
