...
| Cron                                    |       Backend        |                     Демон на linux для выполнения отложенных задач. Будет использоваться для удаления старых вложений и запуска обработки мл микросервисом жалоб в службе поддержки.                     |
...
|-------------------|:-----:|:-------:|:-------:|:---:|
| web&&mobile nginx |   267 361   | 401 041 | 802 082 |  2  |

через web&&mobile nginx и web&&mobile api gateway будут проходить все запросы.
Общий RPC = 267361 + 16204 + 22338 + 3704 + 1736 + 
