...
На бекенде индексов не будет, т.к. имеем первичные ключи, в соответствии с которыми будут отсортированы данные в касандре, также по этим полям будет шардироваться бд.
