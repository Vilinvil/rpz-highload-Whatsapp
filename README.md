...
За год:
1 149 Байт * 802 084 RPS * (365д * 24ч * 60м * 60с) / (1024^4) = 26 444 Тбайт
...
|   Таблица    |                RPS                | Хранилище Тбайт |
|:------------:|:---------------------------------:|:---------------:|
|   message    | 802 082 * 2 + 167 534 = 1 771 698 |     26 444      |
|     view     |              802 082              |      4 786      |
|   reaction   |              67 014               |      1 109      |
| call_history |                692                |        2        |
| report_abuse |                36                 |  не учитываем   |
|     user     |                 9                 |  не учитываем   |
