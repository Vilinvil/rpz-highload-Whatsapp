...
| auth.auth                                       |         1 103 339         |  276   |   4 Гб   |   8 Гбит/с   |
...
Предположим Go в 1.25 раз требовательнее к CPU чем С++ и в 1.5 раз требовательнее к RAM. Тогда 
таблица на основе методических указаний потребления ресурсов на ядро [23].
...
CPU = 1 103 339 / 4000 = 276 ядер;
RAM = 276 * 15 Мб = 4 Гб;
Net = 1 Кбайт * 1 103 339 = 8 Гбит/с.
...
### Хранилища данных
**Amazon S3**:
Т.к. оседает по предположению выше 30% трафика:
(1335 + 116 + 2712 + 27)Гбит/с * 0.3 * (24д * 60мин * 60с) / (8 * 1024^2) = 13 Пбайт в день
...
23. Методические указания к дз 11 https://github.com/init/highload/blob/main/highload_l11_hosting.md
