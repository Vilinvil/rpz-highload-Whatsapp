...
15 910 Тбайт * 30д + (14.8 Пбайт * 1024 / 12 месяцев) = 478 563 Тбайт в месяц

Согласно калькулятору от Amazon [26] для азиатского региона сумма составит 2 450 244 в месяц.

В Google cloud посчитаем тариф Archive storage, т.к. он также для редко используемых данных с миллисекундными ответами.
