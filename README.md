...
Количество скачиваний взял за 2023 год и поделил на 5 [12]. 
...
И 1.4 млрд голосовых сообщений в день. Количество регистраций примем равным 
количеству скачиваний. Авторизации рассчитывать не будем, 
т.к. в WhatsApp авторизация постоянна.
...
Трафик регистраций: 80 млн в год / 365 дней * 0.6 Мбайт = 0.1 Тбайт (далее не учитываем)
...
Кол-во запросов на регистрацию: 80 млн в год / (365 д * 60 мин * 60 с) = 60 запросов/сек
...
| Запросы на создание голосового звонка |  231 запросов/сек   |
| Запросы на регистрацию                |   60 запросов/сек   |
...
12. Статистика по скачиваниям https://www.businessofapps.com/data/whatsapp-statistics/
