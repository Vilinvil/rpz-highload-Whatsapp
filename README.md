...
Clustering key (обознач. С ↑, ↓ по возрастанию и по убыванию сооответственно)отвечает порядок строк,
в котором лежата на одной машине записи из одной таблицы. Приведу основные запросы к таблицам
