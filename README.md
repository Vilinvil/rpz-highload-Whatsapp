...
## 5. Логическая и физическая  схема базы данных
...
Индексы на бекендах не используются, т.к. имеем первичные ключи, в соответствии с которыми будут отсортированы данные в касандре, также по этим полям будет шардироваться бд.
